        ...
        <div class="col-md-6">
          ...
          <form @submit.prevent="buatElemenCp">
            <div class="mb-4">
              ...
              <input v-model="form.elemen" type="text" id="elemen" class="form form-control form-control-lg" placeholder="ketik elemen mapel PKL disini" required>
            </div>
            <div class="my-4">
            ...
            <nuxt-link to="/elemen" class="btn btn-danger border border-2 border-dark">Kembali</nuxt-link>
