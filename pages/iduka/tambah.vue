          ...
          <div class="col-md-6">
            <div class="form-group">
              <div class="mb-4">
                ...
                <input v-model="form.nama" type="text" id="nama" class="form form-control form-control-lg" placeholder="Tulis nama IDUKA" required autofocus>
              </div>
              <div class="mb-4">
                <label for="alamat">Alamat</label>
                <textarea v-model="form.alamat" id="alamat" class="form form-control form-control-lg" cols="30" rows="3" placeholder="Alamat lengkap IDUKA. Gunain search enginge kalau bingung" required></textarea>
              </div>
              <div class="mb-4">
                <label for="pimpinan">Pimpinan/PIC</label>
                <input v-model="form.pimpinan" type="text" id="pimpinan" class="form form-control form-control-lg" placeholder="Kalau belum tahu, ketik '—'" required>
              </div>
              <div class="mb-4">
                <label for="kontak">Kontak</label>
                <input v-model="form.kontak" type="text" maxlength="13" min="0" id="kontak" class="form form-control form-control-lg" placeholder="di search engine biasanya ada" required>
              </div>
              <div class="mb-4">
                <label for="email">Email</label>
                <input v-model="form.email" type="email" id="email" class="form form-control form-control-lg" placeholder="(biasanya) email juga ada" required>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <div class="mb-4">
                ...
                <input v-model="form.jumlah_kuota" type="number" min="1" max="15" id="kuota" class="form form-control form-control-lg" required>
              </div>
              ...
              <div class="mb-4">
                ...
                <select v-model="form.pembimbing_sekolah" id="pem_sekolah" class="form form-control form-select form-select-lg">
              ...
              <div class="mb-4">
                ...
                <input v-model="form.pembimbing_iduka" type="text" id="pem_iduka" class="form form-control form-control-lg" placeholder="Kalau belum tahu, ketik '—'" required>
              </div>
              <div class="mb-4">
                <label for="wilayah">Wilayah</label>
                <select v-model="form.wilayah" id="wilayah" class="form form-control form-select form-select-lg" required>
