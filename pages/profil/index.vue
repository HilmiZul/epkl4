<template>
  <div class="card">
    <div class="card-header">
      <span class="h5 quicksand fw-bold"><i class="bi bi-person-fill"></i> Profil</span>
    </div>
      ...
      <div class="row">
        <div class="col-md-6">
          <form @submit.prevent="updatePersonal">
            ...
            <button :disabled="isSending || form.nama.length < 4" class="btn btn-dark me-2 border border-2 border-dark">
