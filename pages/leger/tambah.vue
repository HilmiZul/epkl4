                ...
                <div class="col-lg-6">
                  <nav>
                    <div class="nav nav-tabs small" id="nav-tab" role="tablist">
                      ...
                      <button @click="() => isSaved = false" class="nav-link p-2" id="iduka-tab" data-bs-toggle="tab" data-bs-target="#nav-iduka" type="button" role="tab" aria-controls="nav-presensi" aria-selected="false">IDUKA</button>
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-4">
                          ...
                          <textarea v-model="form.deskripsi_elemen1" class="form form-control" cols="30" rows="6" placeholder="salin deskripsi disamping..." required></textarea>
                        </div>
                      </div>
                      <div class="col-lg-6">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-4">
                          ...
                          <textarea v-model="form.deskripsi_elemen2" class="form form-control" cols="30" rows="6" placeholder="salin deskripsi disamping..." required></textarea>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="text-muted">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-4">
                          ...
                          <textarea v-model="deskripsi_temp3" readonly class="form form-control" cols="30" rows="6" placeholder="pratinjau deskripsi..." required></textarea>
                        </div>
                      </div>
                      <div class="col-lg-6">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-4">
                          ...
                          <textarea v-model="deskripsi_temp4" readonly class="form form-control" cols="30" rows="6" placeholder="pratinjau deskripsi..." required></textarea>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-4">
                          ...
                          <input v-model="form.sakit" name="sakit" type="number" min="0" id="sakit" class="form form-control form-control-lg" />
                        </div>
                        <div class="mb-4">
                          <label for="izin">Izin</label>
                          <input v-model="form.izin" type="number" min="0" id="izin" class="form form-control form-control-lg" />
                        </div>
                        <div class="mb-4">
                          <label for="tanpa_keterangan">Tanpa keterangan</label>
                          <input v-model="form.tanpa_keterangan" type="number" min="0" id="tanpa_keterangan" class="form form-control form-control-lg" />
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-4">
                          ...
                          <input v-model="formIduka.pembimbing_iduka" id="instruktur" type="text" class="form form-control form-control-lg" required>
                        </div>
                      </div>
                    </div>
                  </div>
...
useHead({ title: "Serahkan Nilai — e-PKL / SMKN 4 Tasikmalaya." })
...
let students = ref([])
let isLoadingPeserta = ref(false)
let id_iduka = ref()
let formIduka = ref({
  pembimbing_iduka: ""
})

async function buatNilai() {
  ...
  try {
    ...
    form.value.iduka = id_iduka.value
