<template>
  <div class="card">
    <div class="card-header">
      <span class="h4 quicksand">User Peserta / <span class="text-dark fw-bold">Tambah baru</span></span>
    </div>
    <div class="card-body">
      <div class="row">
        <div class="col-md-12">
          <div class="alert alert-warning border-5 border-dark shadow-lg">
            ...
            <ul class="small">
              <li>Pembautan User ini digunakan Peserta untuk login ke aplikasi</li>
