<template>
  <div class="card">
    <div class="card-header">
      <span class="h4 quicksand">User Peserta / <span class="text-dark fw-bold">Impor dari .csv</span></span>
    </div>
    <div class="card-body">
      <div class="row">
        <div class="col-md-12">
          <div class="alert alert-warning border-5 border-dark shadow-lg">
            ...
            <ul>
              <li>Impor User untuk Peserta dilakukan oleh Profesional</li>
              <li>Sebelum impor, pastikan sesuai dengan format <nuxt-link to="https://docs.google.com/spreadsheets/d/1Q5mfr7UTqWlmkGLVMe8NdYgQfczttdKiYtHJj9GX2gA/edit?usp=sharing" target="_blank" class="link">disini</nuxt-link> (sheet USER - [program_keahlian])</li>
              <li>Sistem hanya membaca file <code>.CSV</code></li>
              <li>username = NIS, password = NPSN</li>
...
useHead({ title: "Impor User Peserta — e-PKL / SMKN 4 Tasikmalaya." })
