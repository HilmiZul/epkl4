<template>
  <nav class="navbar navbar-expand-lg bg-body-tertiary mb-3">
    <div class="container-fluid">
      <nuxt-link v-if="user" class="navbar-brand lexend-mega text-grey" to="/">Halo, <span class="border-3 border-bottom">{{ username.charAt(0).toUpperCase() + username.slice(1) }}</span>! 😃</nuxt-link>
